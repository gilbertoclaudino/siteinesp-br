...
var client_references_default = {
	"004040a1f54f": async () => {
		const m = await import("./assets/contact-form-CEwWqqJu.js");
		return { get "ContactForm"() {
			return m["ContactForm"];
		} };
	},
	"15c18cfaeeff": async () => {
		const m = await import("./assets/layout-segment-context-39gZRl7R.js");
		return { get "LayoutSegmentProvider"() {
			return m["LayoutSegmentProvider"];
		} };
	},
	"593f344dc510": async () => {
		const m = await import("./assets/error-boundary-DvmCyE5L.js");
		return {
			get "ErrorBoundary"() {
	...
	"c2747888630f": async () => {
		const m = await import("./assets/link-BHxxD6xw.js");
		return { get "default"() {
			return m["default"];
		} };
	}
